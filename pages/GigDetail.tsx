            ...
            <div className="flex flex-col lg:flex-row gap-8 items-start">
                ...
                <div className="w-full lg:w-80 shrink-0 space-y-6 sticky top-24">
                    <div className="bg-white dark:bg-gray-800 rounded-xl border border-border-color dark:border-gray-700 shadow-card p-6">
                        <h3 className="font-bold text-lg text-text-primary dark:text-white mb-2">Ready to Bid?</h3>
                        <p className="text-xs text-text-secondary dark:text-gray-400 mb-4">Submit your rate and pitch to compete for this opportunity.</p>
                        <button
                        ...
                        <p className="text-center text-xs text-text-secondary dark:text-gray-500 mt-3">
                            Bidding closes in 24 hours • 8 bids placed
                        </p>
                    </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-float w-full max-w-lg relative z-10 animate-in fade-in zoom-in-95 duration-200 overflow-hidden">
                        ...
                        {!isSuccess ? (
                                ...
                                <div className="p-6 flex flex-col gap-4">
                                    <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 rounded-lg p-3">
                                        <div className="flex items-center gap-2 text-blue-700 dark:text-blue-400">
                                            ...
                                            <span className="text-xs font-medium">Budget range: {gigData.budget}</span>
                                        </div>
                                    </div>
                                    <div>
                                        <label className="block text-xs font-bold text-text-primary dark:text-gray-300 uppercase tracking-wide mb-1.5">Your Bid Amount ($)</label>
                                    ...
                                    <div>
                                        ...
                                        <textarea className="w-full px-4 py-3 rounded-lg border border-border-color dark:border-gray-700 bg-white dark:bg-gray-900 text-text-primary dark:text-white focus:ring-primary focus:border-primary resize-none h-28 text-sm" placeholder="Why should the brand choose you? Highlight your relevant experience..."></textarea>
                                    </div>
                                    <button onClick={handleApply} className="w-full py-3 bg-primary text-white font-bold rounded-lg hover:bg-primary-hover shadow-lg shadow-primary/20 transition-all flex items-center justify-center gap-2">
                            ...
                            <div className="p-8 flex flex-col items-center text-center">
                                ...
                                <h3 className="text-xl font-bold text-text-primary dark:text-white mb-2">Bid Submitted!</h3>
                                <p className="text-text-secondary dark:text-gray-400 text-sm mb-6">Your bid for <strong>{gigData.title}</strong> has been submitted. The brand will review all bids and select a winner. Track your bid status in "My Bids".</p>
                                <div className="flex gap-3 w-full">
                                    <Link to="/campaigns" onClick={() => setIsModalOpen(false)} className="flex-1 py-2.5 bg-gray-100 dark:bg-gray-700 text-text-primary dark:text-white font-semibold rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors text-center">
                                        View My Bids
                                    </Link>
