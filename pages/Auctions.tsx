    ...
    <div className="max-w-[1200px] mx-auto flex flex-col gap-6 p-6">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="hidden lg:grid grid-cols-12 gap-4 px-6 py-2 text-xs font-semibold text-text-secondary dark:text-gray-400 uppercase tracking-wider">
          <div className="col-span-4">Gig & Brand</div>
          <div className="col-span-2">Bid Amount</div>
        ...
        {activeTab === 'active' && (
          <>
            {/* Item 1 */}
            <Link to="/gigs/vr-headset-review" className="bg-white dark:bg-gray-800 rounded-xl border border-border-color dark:border-gray-700 shadow-card hover:shadow-lg transition-all duration-200 group block">
            ...
            {/* Item 2 */}
            <Link to="/gigs/morning-routine" className="bg-white dark:bg-gray-800 rounded-xl border border-border-color dark:border-gray-700 shadow-card hover:shadow-lg transition-all duration-200 group relative overflow-hidden block">
            ...
            {/* Item 3 */}
            <Link to="/gigs/productivity-tool" className="bg-white dark:bg-gray-800 rounded-xl border border-border-color dark:border-gray-700 shadow-card hover:shadow-lg transition-all duration-200 group block">
              <div className="p-5 grid grid-cols-1 lg:grid-cols-12 gap-4 items-center">
                <div className="lg:col-span-4 flex items-center gap-4">
                  <div className="size-12 rounded-lg bg-gray-50 dark:bg-gray-700 border border-gray-100 dark:border-gray-600 flex items-center justify-center shrink-0">
                ...
                <div className="lg:col-span-2 flex justify-start lg:justify-end gap-2 mt-2 lg:mt-0">
                  <Link to="/gigs/productivity-tool" onClick={(e) => e.stopPropagation()} className="px-4 py-2 text-xs font-semibold text-text-primary dark:text-white bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors z-10 relative">Details</Link>
                  <button className="p-2 text-text-secondary dark:text-gray-400 hover:text-text-primary dark:hover:text-white rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700" aria-label="More options">
                    <span className="material-symbols-outlined text-[20px]">more_vert</span>
                  </button>
                </div>
              </div>
        ...
        {activeTab !== 'active' && (
          <div className="py-12 flex flex-col items-center justify-center text-center text-text-secondary dark:text-gray-500">
            <span className="material-symbols-outlined text-[48px] mb-2 opacity-50">gavel</span>
            <p>No {activeTab} gigs to display yet.</p>
            <button onClick={() => setActiveTab('active')} className="mt-4 text-primary font-semibold hover:underline">View Active Gigs</button>
          </div>
        )}
      </div>
      ...
      {isBidModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-float w-full max-w-md relative z-10 animate-in fade-in zoom-in-95 duration-200 overflow-hidden">
            ...
            <div className="p-6">
              <p className="text-sm text-text-secondary dark:text-gray-400 mb-4">Placing a bid for <strong>{selectedAuction}</strong>. Your previous bid was outmatched.</p>
