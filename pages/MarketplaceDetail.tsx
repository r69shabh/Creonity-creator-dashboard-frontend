...
const MarketplaceDetail: React.FC = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 pb-20">
      <Link to="/marketplace" className="inline-flex items-center gap-2 text-text-secondary dark:text-gray-400 hover:text-primary dark:hover:text-white mb-6 font-medium text-sm transition-colors">
      ...
      <div className="flex flex-col lg:flex-row gap-8 items-start">
        ...
        <div className="flex-1 w-full">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl border border-border-color dark:border-gray-700 shadow-sm overflow-hidden mb-6">
                <div className="h-64 w-full bg-cover bg-center relative" style={{ backgroundImage: `url("${opportunity.img}")` }}>
                ...
                <div className="p-6 relative">
                    <div className="absolute -top-10 right-6 size-20 bg-white dark:bg-gray-800 rounded-2xl border-2 border-white dark:border-gray-700 shadow-lg flex items-center justify-center p-2">
                        <img src={opportunity.logo} alt="Brand" className="w-full h-full object-contain" />
                    </div>
                    <div className="mb-6">
                        <h1 className="text-2xl md:text-3xl font-bold text-text-primary dark:text-white mb-2">{opportunity.title}</h1>
                        <div className="flex items-center gap-2 text-sm text-text-secondary dark:text-gray-400">
                             <span className="font-semibold text-text-primary dark:text-gray-200">{opportunity.brand}</span>
                             <span>•</span>
             ...
             {!isSuccess ? (
                 <>
                    <div className="px-6 py-4 border-b border-border-color dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50 flex justify-between items-center">
                        <h3 className="font-bold text-text-primary dark:text-white">Apply for Opportunity</h3>
                 ...
                 <div className="p-8 flex flex-col items-center text-center">
                     ...
                     <p className="text-text-secondary dark:text-gray-400 text-sm mb-6">Your application for <strong>{opportunity.title}</strong> has been sent to the brand. You can track the status in the "My Work" section.</p>
