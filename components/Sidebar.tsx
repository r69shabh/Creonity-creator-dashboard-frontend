    ...
    >
      ...
      <div className="p-4 mt-auto border-t border-gray-100 dark:border-gray-800">
        <button
          ...
          className="w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-text-secondary dark:text-gray-400 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 transition-all font-medium text-sm"
          aria-label="Log out"
        >
